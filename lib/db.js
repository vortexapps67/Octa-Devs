  ...
  team_members: [
    {
      ...
      avatar_url: '',
      socials: { linkedin: '', twitter: '', github: '', portfolio: '' },
      sort_order: 1,
...
class DatabaseService {
  ...
  async createTeamMember(payload) {
    ...
    if (payload.portfolio) socials.portfolio = payload.portfolio;
  ...
  async updateTeamMember(id, payload) {
    ...
    if (payload.portfolio !== undefined) socials.portfolio = payload.portfolio;
